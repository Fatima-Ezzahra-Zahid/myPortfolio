...
if(isset($_POST['sub']))

    {
        ...
        $stmt=$db->prepare('UPDATE projects SET name_project=:name_project,category=:category,project_date=:project_date,url_project=:url_project,desc_project=:desc_project,pict=:pict WHERE id_pro=:uid');
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal"  method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="project_date" class="form-control" value="<?php echo  $project_date ?>">
                                            </div>
                                        </div>
