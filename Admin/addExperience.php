...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
        ...
        try{
            if(isset($_POST['title']) && isset($_POST['years']) && isset($_POST['name'])){
                ...
                $query = "INSERT INTO professional_expe(`title`,`years`,`name`)VALUES($title,$years,$name)";
                $select = $db->query($query);
                if(!empty($select)){
                    header('Location:Experience.php?addExperience=true&msg=added');                 
                } else {
                    $msg="Error Work";
                }
            }
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">Add Professional Experience</div>
                                <div class="card-body">
