        ...
        try{
            if(isset($_POST['title']) && isset($_POST['years']) && isset($_POST['name'])){
                ...
                $name = $db->quote($_POST['name']);
                    ...
                    $query = "UPDATE `education` SET `id_ed`= $id_c,`title`=$title,`years`=$years,`name_sc`= $name WHERE id_ed= $id_c";

               
                $msg=$query;
                $select = $db->query($query);
                if(!empty($select)){
                    header('Location:education.php?editEducation=true&msg=updated');                 
                } else {
                    $msg="Error Work";
                }
            }
...
$select = $db->query('SELECT * FROM education where  id_ed = '.Session::get('id_c_edit'));
$educ = $select->fetchAll();
?>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal"  method="POST">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="title" class="form-control" value="<?= $educ["title"] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="years" class="form-control" value="<?= $educ["years"] ?>">
                                            </div>
                                        </div>
                                        <div class="line"></div><br>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="name" class="form-control" value="<?= $educ["name_sc"] ?>">
                                            </div>
                                        </div>
