...
if($_SERVER['REQUEST_METHOD'] == "POST"){ 
        ...
        try{
            if(isset($_POST['client']) && isset($_POST['project']) && isset($_POST['hours']) && isset($_POST['hard'])){
                $cl = $db->quote($_POST['client']);
                $pro = $db->quote($_POST['project']);
                $hr = $db->quote($_POST['hours']);
                $hard = $db->quote($_POST['hard']);
                $query = "INSERT INTO counte(`nb_cl`,`nb_projetc`,`nb_hours`,`nb_workes`)VALUES($cl,$pro,$hr,$hard)";
                $select = $db->query($query);
                if(!empty($select)){
                    header('Location:Count.php?addCount=true&msg=added');                
                } else {
                    $msg="Error Work";
                }
            }
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal"  method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="hard" class="form-control">
                                            </div>
                                        </div>
