...
<body>
  ...
  <header id="header" class="header-tops">
    <div class="container">
      ...
      <h1><a href="index.html">Fatima-Ezzahra Zahid</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a> -->
      <h2>I'm a passionate <span>Web development</span></h2>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          <h3>UI/UX &amp; Web development</h3>
          <p class="font-italic">
           
           I am passionate about the web and new technologies. Currently a student in YouCode programming school, I want to eventually become a web developer.
          </p>
          <div class="row">
            <div class="col-lg-6">
              <ul>
                <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong>27 November 1997</li>
                <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> +212 665754482</li>
          ...
          <p>
            I use programming languages such as HTML, CSS, JavaScript for the front end ,and in the process of learning SQL,PHP,laravel from the back end part.
          </p>
        </div>
      </div>
  ...
  <div class="credits">
    Designed by <a href="">Fatima-Ezzahra</a>
  </div>
